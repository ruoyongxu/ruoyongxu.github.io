...
Ruoyong Xu, Patrick Brown (2025). [clrng: A tool set for parallel random number generation on GPUs in R.] Link will be available soon. Accepted for publication at Journal of Statistical Computation and Simulation. 
